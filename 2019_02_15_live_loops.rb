...
live_loop :background do
  use_synth :mod_beep
  notes = (scale :a1, :major, num_octaves: 2)
  notes.shuffle
  play notes.tick
  sleep 0.5
end
...
live_loop :appregios do
  appregio_player :pretty_bell, :c2, :major, 0.25, 1, 0.25
  sleep 0.5
  appregio_player :pretty_bell, :a3, :minor, 0.25, 1, 0.25
  sleep 0.5
end
...
live_loop :riffs do
  ...
  sleep 0.5
  riff_player :mod_tri, :a1, :major_pentatonic, 3, 3, 1, 0.25
  sleep 0.5
end
