...
function movingRandomFlower(thea){
...
function magicRectangles(mx, my, msz){
  var innera, innerx, innery;
  var loopsie = int(random(1,4));
  fill(random(255),random(255),random(255),random(99,100));
  rectMode(CENTER);
...
//TODO, implement this https://p5js.org/examples/simulate-spirograph.html as its own modular function
