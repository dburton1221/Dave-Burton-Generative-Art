...
in_thread do
  chord_player :piano, :d3, :minor, 3, 0.5
end
melody 1, 3, :beep
in_thread do
  appregio_player :beep, :e4, :minor, 0.25, 2, 0.1
end
melody_two 1, 3, :beep, :piano
melody_three 1, 3, :beep, :piano, :pluck
appregio_player :beep, :e4, :minor, 0.25, 2, 0.1
melody 1, 3, :beep
melody_three 1, 3, :beep, :piano, :pluck
appregio_player :beep, :a4, :major, 0.25, 2, 0.1
melody 0.5, 2, :piano
chord_player :piano, :d3, :minor, 3, 0.5
riff_player :beep, :b3, :minor, 2, 4, 2, 0.5
