...
class Shootingstars { //when moving this over into the official script, you must have the class before the functions
  constructor() {
    ...
    this.diameterx = random(10, 30);
    this.diametery = random(10,30);
...
function makeBackground(){
  rectMode(CENTER);
  noStroke();
  fill(random(255),random(255),random(255),100); //the covering up the background, 255 all is white, 0 is black
