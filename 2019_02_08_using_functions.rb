...
in_thread do
  scale_player :pluck, :e1, :minor, 1, 1, 0.1
end
melody 1, 2, :beep
melody_four 1, 3, :beep, :piano, :pluck, :prophet
in_thread do
  scale_player :pluck, :e1, :minor, 2, 1, 0.1
  riff_player :prophet, :c1, :minor, 1, 4, 2, 0.5
end
melody_two 1, 2, :pretty_bell, :piano
melody_three 1, 3, :pretty_bell, :piano, :pluck
melody_four 1, 2, :pluck, :piano, :pretty_bell, :prophet
melody 1, 2, :pluck
melody_three 1, 3, :pretty_bell, :piano, :pluck
in_thread do
  scale_player :pluck, :e3, :minor, 2, 2, 0.1
end
in_thread do
  appregio_player :pretty_bell, :a1, :minor, 0.15, 1, 0.1
  chord_player :piano, :d1, :minor, 3, 0.5
  scale_player :pluck, :e1, :minor, 2, 2, 0.1
end
melody 0.5, 2, :piano


use_random_seed 1561
the_control_mix :mono, :gverb, :compressor, 3,
  :beep, :piano, :pluck, :prophet,0.125,
  [:a2, :b3, :c1, :d1]

use_random_seed 1538635896
the_control_mix :whammy, :gverb, :bitcrusher, 3,
  :beep, :mod_tri, :dull_bell, :prophet,0.125,
  [:a2, :b3, :c1, :d1, :e1, :f3, :g2]

use_random_seed 318509628934108
