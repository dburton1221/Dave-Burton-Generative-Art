...
scale_player :tri, :d1, :major_pentatonic, 2, 2, 0.1
riff_player :beep, :c1, :major_pentatonic, 2, 4, 2, 0.5
appregio_player :dsaw, :e2, :minor, 0.25, 3, 0.1
chord_player :mod_tri, :a3, :major, 3, 0.5
chord_player :dsaw, :d3, :major, 3, 0.5
use_random_seed 302
the_control_mix :echo, :whammy, :distortion, 10,
  :tri, :pulse, :beep, :dtri,
  [:a1, :b1, :c1, :d1, :e1, :f1]
use_random_seed 903901
