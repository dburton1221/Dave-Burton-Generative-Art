...
with_fx :reverb do
  in_thread do
    use_random_seed 3151382-653-946
...
with_fx :whammy do
  3.times do
    melody_two 1, 3, :mod_sine, :piano
    appregio_player :mod_sine, :e3, :minor, 0.25, 1, 0.2
    chord_player :mod_sine, :d3, :major, 3, 0.5
    riff_player :mod_sine, :c1, :major_pentatonic, 2, 4, 2, 0.5
